...
require '../connect.php'; ?>
<?php
//on détruit toutes les sessions précédentes
session_unset ();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="input-group">
                  ...
                  <input name="date_enc" type="text" placeholder="<?php echo $fetch_prenom;  ?>" class="form-control validate[required]" required  />
              </div><br>
              <i class="metismenu-icon pe-7s-bookmarks"></i>
             <label class="">Libellé: <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
             <div class="input-group">

                 <input name="libelle" type="text" placeholder="<?php echo $fetch_classe; ?>" class="form-control validate[required]" required  />
             </div><br>
			  <i class="metismenu-icon pe-7s-server"></i>
               <label class="">Montant : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">

                  <input name="montant" type="text" placeholder="<?php echo $fetch_motif; ?>" class="form-control validate[required]" required  />
              </div><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="input-group">
                  ...
                  <input name="date_enc" type="text" placeholder="<?php echo $fetch_prenomt;  ?>" class="form-control validate[required]" required  />
              </div><br>
              <i class="metismenu-icon pe-7s-bookmarks"></i>
             <label class="">Libellé: <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
             <div class="input-group">

                 <input name="libelle" type="text" placeholder="<?php echo $fetch_classet; ?>" class="form-control validate[required]" required  />
             </div><br>
			  <i class="metismenu-icon pe-7s-server"></i>
               <label class="">Montant : <span style="color:red; font-weight: bold; font-family: Arial, sans-serif ;">(*)</span></label>
              <div class="input-group">

                  <input name="montant" type="text" placeholder="<?php echo $fetch_motift; ?>" class="form-control validate[required]" required  />
              </div><br>
