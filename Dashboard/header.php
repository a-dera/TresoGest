<div class="app-header header-shadow ">
            ...
            <div class="app-header__menu">
                ...
                <div class="app-header-left">
                    ...
                    <script src="js/journee.js"></script>
                    <ul class="header-menu nav">
                        <li class="nav-item">
                                <br>

                                <p class="">Nous sommes le
                            		<!--script pour compteur automatique de date en JS et en Français.-->
                            			<script>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <button type="button" tabindex="0" class="dropdown-item">
                                              ...
                                              Mon Compte</a></button>
                                            <button type="button" tabindex="0" class="dropdown-item">
                                              <a href= "" data-toggle="modal" data-target="#tresoModal">
                                              Ma tresorerie</a></button>
                                            <!--<h6 tabindex="-1" class="dropdown-header">Header</h6>-->
                                          <!--  <button type="button" tabindex="0" class="dropdown-item">Paramètres</button-->
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                            <button type="button" tabindex="0" class="dropdown-item">
                                                <a href= "../logout.php">
                                                  Me déconnecter</a></button>
                                        </div>
                                    </div>
                                </div>
